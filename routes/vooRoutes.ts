...
routerVoo.get("/editar/voo", VooController.updateVoo);
routerVoo.post("/editar/voo", VooController.updateVooSave);
routerVoo.post("/excluir/voo", VooController.removeVoo);
